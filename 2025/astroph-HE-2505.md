...
## May 22
### [Orbital Phase-resolved Analysis of X-ray and Gamma-ray Observations of the High-Mass Gamma-ray Binary 4FGL J1405.1-6119](https://arxiv.org/pdf/2505.13716v1)
> 我们展示了对高质量伽马射线双星系统 4FGL J1405.1-6119 的多波段观测结果。两次联合的 XMM-Newton 和 NuSTAR 观测于2019年进行，分别对应伽马射线峰值和X射线峰值阶段，揭示了软X射线和硬X射线的辐射特性。我们发现视线方向上的氢柱密度（$N_{\rm H}$）和光子指数（$\Gamma$）存在变化，同时在X射线中未发现脉冲信号。此外，我们将轨道周期精确为 $P = 13.7157 \pm 0.0014$ 天，这是首次基于将近16年的Fermi–LAT观测数据对4FGL J1405.1-6119进行轨道相位分辨分析，并研究了其光谱形状随轨道相位的演化。最后，新X射线观测所覆盖相位的X射线和伽马射线光谱可以在双星系统内部激波模型框架下进行解释，该模型此前已应用于类似的高质量伽马射线双星系统，如LS 5039。

## May 28
### [On the nature of the X-ray binary transient MAXI J1834–021: clues from its first observed outburst](https://arxiv.org/pdf/2505.20019v1)
>Maxi J1834-021是一种新的X射线暂现源，在2023年2月发现。我们使用NICER，NUSTAR和2023年3月收集的Swift数据分析了Maxi J1834-021的光谱和时变特性。光曲线显示了主要的峰值，显示了主要的峰值。从单个更好的观察结果中提取的大多数光谱可以充分地拟合成一个组分成分，而其中一些需要额外的热成分。光谱演化与软化趋势是一致的，因为源在X射线中变得更明亮。我们还分析了宽带光谱，结合了2023年3月10日的同时和nustar观察的数据。该光谱可以与圆盘组件一起安装，温度的内部半径为$ kt _ {\ rm in} \ in} \ sim 0.4 $ kev和comptonisation 0.4 $ kev和comptonisation $ $ $ \ sim $ \ \ \ \ \ \ f \ sim 1.88。通过在建模中加入反射成分，我们获得了11.4重力半径的内盘半径的3 $ \ sigma $上限。我们还检测到了准周期性振荡（QPO），其中央频率随时间而变化（从2 Hz到$ \ sim $ 0.9 Hz），并且具有硬度比的抗可相互作用。基于观察到的光谱时变属性，Maxi J1834-021可以归类为爆发中的低质量X射线双星。但是，我们无法就致密天体的性质得出明确的结论，目前，该物体也可能是黑洞或中子星。
